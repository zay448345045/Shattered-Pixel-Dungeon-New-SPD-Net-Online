...
public enum Mode {
	IRONMAN("铁人模式", "没有玩家之间的实质性交互，使用你的技巧争夺排行榜上的高分，证明自己是地牢高手。", Assets.Sprites.RATKING, 0, 0, 16, 16),
	FUN("娱乐模式", "随便摸，乐就行了。 : )", Assets.Sprites.RAT, 0, 0, 16, 16),
	DAILY("每日挑战", "每天都有新的地牢，每天都有新排行榜", Assets.Sprites.RAT, 0, 15, 16, 16);
	@Getter
